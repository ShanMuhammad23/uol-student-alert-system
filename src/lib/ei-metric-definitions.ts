...
export const EI_CRITERION_DEFINITIONS: EiCriterionDefinition[] = [
  ...
  },
  {
    ...
    weight: 0.1,
    piTarget: "≤ 2 days",
    formula: "Median days from current alert streak start to first instructor action",
    tooltip:
      "Median days from the start of the student’s current alert period to the first instructor action. Target: ≤ 2 days. Score reduces 20% for each day over target. Weight: 10%.",
    higherBetter: false,
    sortOrder: 3,
  },
  {
    ...
    formula: "Alerted students with intervention ÷ Total alerted students",
    tooltip:
      "Share of currently alerted students with at least one faculty intervention on record. Target: 95%. Normalized against the 95% PI. Weight: 10%.",
    higherBetter: true,
    sortOrder: 4,
  },
  {
    ...
    formula: "Open cases (alerted students) with all action gaps ≤ 10 days ÷ Open cases",
    tooltip:
      "Open intervention cases for currently alerted students where no gap between consecutive actions exceeds 10 days. Weight: 10%.",
    higherBetter: true,
    sortOrder: 5,
  },
  {
    ...
    formula: "Cases closed or referred (alerted students) ÷ Total cases",
    tooltip:
      "Intervention cases for currently alerted students that are closed or referred to Wellbeing. Weight: 5%.",
    higherBetter: true,
    sortOrder: 6,
  },
  {
