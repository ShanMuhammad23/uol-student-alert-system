...
export function YellowAlert(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#EAB308" />
      <path
        d="M29 20v14M29 38a2 2 0 100 4 2 2 0 000-4z"
        stroke="#fff"
        strokeWidth={2}
        strokeLinecap="round"
        fill="none"
...
export function RedAlert(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
